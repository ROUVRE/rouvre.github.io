  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="sticky top-4 left-full ml-4 text-gray-400 hover:text-gray-600 transition-colors z-10"
        >
          <svg
            className="w-6 h-6"
            fill="none"
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="w-full h-64 sm:h-80 rounded-lg overflow-hidden mb-6 shadow-md">
            <img
              src={project.image}
              alt={project.title}
